...
//{
  ...
  public class OscMessage
  {
   ...
   public ArrayList values;
    ...
    // ADDED BY KAH to check data count...
  ...
  public class OSC : MonoBehaviour
  {
    ...
    // KAH added this so we can change the IpAddress and ports during runtime


    public void KAHRestart()
    {
        Close();
	...
	void Awake() {
		...
		buffer = new byte[4000];  // KAH increased this from 1000 to 4000
